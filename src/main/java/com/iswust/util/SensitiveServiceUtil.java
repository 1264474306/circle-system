...
@Component
public class SensitiveServiceUtil implements InitializingBean {


    private static final Logger logger = LoggerFactory.getLogger(SensitiveServiceUtil.class);
     ...
     * 过滤敏感词
     */
    public Integer filter(String text) {
